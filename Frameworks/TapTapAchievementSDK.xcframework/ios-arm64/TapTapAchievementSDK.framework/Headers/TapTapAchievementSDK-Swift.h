...
#ifndef TAPTAPACHIEVEMENTSDK_SWIFT_H
#define TAPTAPACHIEVEMENTSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TapTapAchievementSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC20TapTapAchievementSDK26TapAchievementCallbackCode")
@interface TapAchievementCallbackCode : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger UNLOCK_SUCCESS;)
+ (NSInteger)UNLOCK_SUCCESS SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger INCREMENT_SUCCESS;)
+ (NSInteger)INCREMENT_SUCCESS SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger NOT_INITIALIZED;)
+ (NSInteger)NOT_INITIALIZED SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger REGION_NOT_SUPPORTED;)
+ (NSInteger)REGION_NOT_SUPPORTED SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger NOT_LOGGED;)
+ (NSInteger)NOT_LOGGED SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger ACCESS_DENIED;)
+ (NSInteger)ACCESS_DENIED SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger INVALID_REQUEST;)
+ (NSInteger)INVALID_REQUEST SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger NETWORK_ERROR;)
+ (NSInteger)NETWORK_ERROR SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger UNKNOWN_ERROR;)
...
///   </li>
/// </ul>
+ (void)incrementWithAchievementId:(NSString * _Nonnull)achievementId steps:(NSInteger)steps;
/// 上报解锁成就
/// <ul>
///   <li>
///     Parameters :
...
///   </li>
/// </ul>
+ (void)unlockWithAchievementId:(NSString * _Nonnull)achievementId;
/// 注册成就回调
...
/// 成就类型
typedef SWIFT_ENUM(NSInteger, TapTapAchievementType, open) {
  TapTapAchievementTypeNORMAL = 0,
  TapTapAchievementTypePLATINUM = 1,
};

@class WKWebView;

SWIFT_CLASS("_TtC20TapTapAchievementSDK26TapWebViewJavascriptBridge")
...
@interface TapWebViewJavascriptBridge (SWIFT_EXTENSION(TapTapAchievementSDK)) <WKScriptMessageHandler>
...
@interface TapWebViewJavascriptBridge (SWIFT_EXTENSION(TapTapAchievementSDK)) <WKNavigationDelegate>
