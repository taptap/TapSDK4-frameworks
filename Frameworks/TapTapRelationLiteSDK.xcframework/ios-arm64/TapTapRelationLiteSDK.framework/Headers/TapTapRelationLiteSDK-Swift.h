...
#ifndef TAPTAPRELATIONLITESDK_SWIFT_H
#define TAPTAPRELATIONLITESDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TapTapRelationLiteSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
+ (void)inviteGame;
+ (void)inviteTeamWithTeamId:(NSString * _Nonnull)teamId;
+ (void)getFriendsListWithNextPageToken:(NSString * _Nullable)nextPageToken completion:(void (^ _Nullable)(RelationLiteUserResult * _Nullable, NSError * _Nullable))completion;
+ (void)getFollowingListWithNextPageToken:(NSString * _Nullable)nextPageToken completion:(void (^ _Nullable)(RelationLiteUserResult * _Nullable, NSError * _Nullable))completion;
+ (void)getFansListWithNextPageToken:(NSString * _Nullable)nextPageToken completion:(void (^ _Nullable)(RelationLiteUserResult * _Nullable, NSError * _Nullable))completion;
+ (void)syncRelationshipWithOpenIdWithAction:(NSInteger)action nickname:(NSString * _Nonnull)nickname friendNickname:(NSString * _Nonnull)friendNickname friendOpenId:(NSString * _Nonnull)friendOpenId completion:(void (^ _Nullable)(NSError * _Nullable))completion;
...
SWIFT_CLASS("_TtC21TapTapRelationLiteSDK22TapTapRelationLiteCode")
@interface TapTapRelationLiteCode : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger NEED_LOGIN;)
+ (NSInteger)NEED_LOGIN SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger NEED_USER_FRIENDS_SCOPE;)
+ (NSInteger)NEED_USER_FRIENDS_SCOPE SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger REQUEST_ERROR;)
+ (NSInteger)REQUEST_ERROR SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface TapTapRelationLiteSyncType : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger ADD_FRIEND;)
+ (NSInteger)ADD_FRIEND SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger DELETE_FRIEND;)
+ (NSInteger)DELETE_FRIEND SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_PROTOCOL("_TtP21TapTapRelationLiteSDK29TapTapRelationRequestDelegate_")
@protocol TapTapRelationRequestDelegate <NSObject>
@optional
- (void)onFriendsListResultWithFriendsList:(NSArray<RelationLiteUserItem *> * _Nonnull)friendsList nextPageToken:(NSString * _Nullable)nextPageToken;
- (void)onFollowingListResultFollowingList:(NSArray<RelationLiteUserItem *> * _Nonnull)followingList nextPageToken:(NSString * _Nullable)nextPageToken;
- (void)onFansListResultWithFansList:(NSArray<RelationLiteUserItem *> * _Nonnull)fansList nextPageToken:(NSString * _Nullable)nextPageToken;
- (void)onSyncRelationshipSuccessWithOpenId:(NSString * _Nullable)openId unionId:(NSString * _Nullable)unionId;
- (void)onSyncRelationshipFailWithErrorMessage:(NSString * _Nullable)errorMessage openId:(NSString * _Nullable)openId unionId:(NSString * _Nullable)unionId;
- (void)onRequestErrorWithErrorMessage:(NSString * _Nullable)errorMessage;
@end
