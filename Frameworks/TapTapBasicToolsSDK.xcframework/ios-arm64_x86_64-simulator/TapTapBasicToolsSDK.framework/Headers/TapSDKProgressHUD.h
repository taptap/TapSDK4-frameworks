...
typedef NS_ENUM(NSInteger, TapSDKProgressHUDMode) {
    /// UIActivityIndicatorView.
    TapSDKProgressHUDModeIndeterminate,
    /// A round, pie-chart like, progress view.
    TapSDKProgressHUDModeDeterminate,
    /// Horizontal progress bar.
    TapSDKProgressHUDModeDeterminateHorizontalBar,
    /// Ring-shaped progress view.
    TapSDKProgressHUDModeAnnularDeterminate,
    /// Shows a custom view.
    TapSDKProgressHUDModeCustomView,
    /// Shows only labels.
    TapSDKProgressHUDModeText
};
...
typedef NS_ENUM(NSInteger, TapSDKProgressHUDAnimation) {
    ...
    TapSDKProgressHUDAnimationZoomIn
};

typedef NS_ENUM(NSInteger, TapSDKProgressHUDBackgroundStyle) {
    /// Solid color background
    TapSDKProgressHUDBackgroundStyleSolidColor,
    /// UIVisualEffectView or UIToolbar.layer background view
    TapSDKProgressHUDBackgroundStyleBlur
};
 ...
 */
@property (weak, nonatomic) id<TapSDKProgressHUDDelegate> delegate;
 ...
 */
- (void)hudWasHidden:(TapSDKProgressHUD *)hud;
 ...
 */
@interface XDGBarProgressView : UIView
 ...
 * Defaults to TapSDKProgressHUDBackgroundStyleBlur.
 */
@property (nonatomic) TapSDKProgressHUDBackgroundStyle style;

/**
 * The blur effect style, when using TapSDKProgressHUDBackgroundStyleBlur.
