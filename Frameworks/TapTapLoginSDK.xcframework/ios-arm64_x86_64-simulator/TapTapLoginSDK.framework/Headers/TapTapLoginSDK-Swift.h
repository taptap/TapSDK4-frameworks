...
#ifndef TAPTAPLOGINSDK_SWIFT_H
#define TAPTAPLOGINSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TapTapLoginSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14TapTapLoginSDK25TapFirstPartyLoginOptions")
@interface TapFirstPartyLoginOptions : NSObject
@property (nonatomic) BOOL isPreApproved;
...
@class NSError;
SWIFT_CLASS("_TtC14TapTapLoginSDK21TapTapFirstPartyLogin")
@interface TapTapFirstPartyLogin : NSObject
+ (void)loginWith:(NSArray<NSString *> * _Nonnull)scopes viewController:(UIViewController * _Nullable)viewController firstPartyLoginOptions:(TapFirstPartyLoginOptions * _Nullable)firstPartyLoginOptions handler:(void (^ _Nonnull)(TapTapAccount * _Nullable, NSError * _Nullable, BOOL))handler;
/// 获取登录方式
+ (NSString * _Nonnull)getLoginType SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// 如果你的应用支持 iOS 13 Scene，需要在 <code>scene(_:, openURLContexts URLContexts:)</code> 函数中调用
/// 如果你的应用支持 AppDelegate 唤起，需要在 <code>application(_ app: , open url: )</code> 函数中调用
/// \param url 外部唤起应用时所带的 URL
///
///
/// returns:
/// 是否被 TapTapLogin 处理
...
/// OC 的登录方法
+ (void)LoginWithScopes:(NSArray<NSString *> * _Nonnull)scopes viewController:(UIViewController * _Nullable)viewController handler:(void (^ _Nonnull)(BOOL, NSError * _Nullable, TapTapAccount * _Nullable))handler;
...
@class NSCoder;
SWIFT_CLASS("_TtC14TapTapLoginSDK9TapTipHUD")
