...
#ifndef TAPTAPRELATIONSDK_SWIFT_H
#define TAPTAPRELATIONSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TapTapRelationSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
+ (void)startMessenger;
+ (void)inviteGame;
+ (void)inviteTeam:(NSString * _Nonnull)teamId;
+ (void)showTapUserProfileWithOpenId:(NSString * _Nullable)openId unionId:(NSString * _Nullable)unionId;
+ (NSInteger)getNewFansCount SWIFT_WARN_UNUSED_RESULT;
...
/// 好友数据回调
SWIFT_PROTOCOL("_TtP17TapTapRelationSDK22TapTapRelationDelegate_")
@protocol TapTapRelationDelegate <NSObject>
...
@interface TapTapRelationMessengerCode : NSObject
/// 用户未登录
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger NEED_LOGIN;)
+ (NSInteger)NEED_LOGIN SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger ON_NEW_FANS_COUNT_CHANGED;)
+ (NSInteger)ON_NEW_FANS_COUNT_CHANGED SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger GET_NEW_FANS_COUNT;)
+ (NSInteger)GET_NEW_FANS_COUNT SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSInteger ON_NEW_MESSAGE_COUNT_CHANGED;)
+ (NSInteger)ON_NEW_MESSAGE_COUNT_CHANGED SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
